...
-- {{{ Error handling
-- Check if awesome encountered an error on startup
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "q",      function (c) c:kill()                         end,
              {description = "kill focussed window", group = "client"}),
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false } -- set to true to get titlebars
    },
